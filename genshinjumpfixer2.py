...
def main():
    ...
    if results == [None, None, None]:
        ...
        return
    elif results == [False, True, False, False, False]:
        # branch if ZF=1
        jump_insn = "jz"
        swap_targets = False
        ...
        jump_insn = "jc"
        swap_targets = False
    elif results == [True, True, False, False, False]:
        # branch if CF=0 and ZF=0
        jump_insn = "jnbe"
        swap_targets = True
        #swap_targets = False
    elif results == [False, False, False, True, False]:
        # branch if DL=1
        reg_to_test = "dl"
        swap_targets = False
    elif results == [False, False, False, False, True]:
        # branch if R8B=1
        reg_to_test = "r8b"
        swap_targets = False
    else:
